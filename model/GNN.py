...
#                  atom_dim: int, bond_dim: int, output_dim: int, config: Dict[str, Any], use_cuda=False):
...
#         self.atom_embed = nn.Linear(self.atom_dim, self.hidden_dim)
#         self.bond_embed = nn.Linear(self.bond_dim, self.hidden_dim)
#         self.GCN1 = GCNConv(self.hidden_dim, 16)
#         self.GCN2 = GCNConv(16, 3)
#         # self.GCN3 = GCNConv(16, num_label)
